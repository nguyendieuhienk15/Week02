...
public class DetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewPagerAdapter viewPagerAdapter = new ViewPagerAdapter(getActivity().getApplicationContext(), mAttraction.imageUrl, mAttraction.secondaryImageUrl);
        ...
        mapFab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(fab1.getVisibility() == View.INVISIBLE) {
                    ...
                    float spacing = Float.parseFloat(getString(R.string.spacing_fab_menu));

                    fab1.animate().translationY(spacing);
                    fab2.animate().translationY(2 * spacing);
                    fab3.animate().translationY(3 * spacing);
        ...
        //Call to the house owner
        fab1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent callIntent = new Intent(Intent.ACTION_CALL);
                callIntent.setData(Uri.parse("tel:" + getString(R.string.dummy_number)));
